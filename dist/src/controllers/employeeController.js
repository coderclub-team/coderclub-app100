...
const Emplyee_model_1 = __importDefault(require("../models/Emplyee.model"));
...
const getAllEmployees = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const employees = yield Emplyee_model_1.default.findAll({
            attributes: {
                exclude: [
                    "CreatedGUID",
                    "ModifiedGUID",
...
const getEmployeeById = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        const employee = yield Emplyee_model_1.default.findByPk(EmployeeID, {
            attributes: {
                exclude: [
                    "CreatedGUID",
                    "ModifiedGUID",
...
const createEmployee = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        const employee = yield Emplyee_model_1.default.create(req.body);
...
const deleteEmployee = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        if (!Emplyee_model_1.default.options.paranoid) {
