...
employeeRouter.post("/", authGaurd_middleware_1.default, upload_middleware_1.uploadEmployeePhoto, employee_controller_1.createEmployee);
employeeRouter.put("/:EmployeeID", authGaurd_middleware_1.default, upload_middleware_1.uploadEmployeePhoto, employee_controller_1.updateEmployee);
