...
const app_config_json_1 = __importDefault(require("../public/data/app_config.json"));
const app_config = app_config_json_1.default;
...
app.get("/api/app/config", (req, res) => {
    res.status(200).json(app_config_json_1.default);
});
app.listen(3000, () => {
